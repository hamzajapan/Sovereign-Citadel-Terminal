...
fn test_full_dlc_lifecycle() {
    ...
    let offer = ContractOffer {
        ...
        payout_curve: PayoutCurveBuilder::new(Satoshi::from_sat(2_000_000)).linear(60000, 40000),
...
fn test_invalid_state_transitions() {
    ...
    let offer = ContractOffer {
        ...
        payout_curve: PayoutCurveBuilder::new(Satoshi::from_sat(200_000)).binary_winner_takes_all(),
        oracle_info: OracleInfo {
            public_key: oracle.pubkey,
            name: "Oracle".to_string(),
            endpoint: None,
